export type RecordType = "lead" | "person" | "opportunity" | "company" | "project" | "task"
export const ALL_RECORD_TYPES: RecordType[] = ["lead", "person", "opportunity", "company", "project", "task"]
